...
class AuthorizedAccessControlTestCase(TestCase):
    def setUp(self):
        ...
        article = Article.objects.create(title='This is test article 1', author=self.user, synopsis='This is short description of article 1', content='This is content of article 1')
        self.articles_list = [article]
